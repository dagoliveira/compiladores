...
Um detalhe quando se trata de ponto flutuante é a necessidade de alterar o valor para `double`, caso contrário apenas um 0 será impresso na tela. Isso porque printf é uma função variádica, e a especificação requer uma promoção de float para double. Portanto, o seguinte código em C;
